...
st.markdown('<h3 style="color: #F3FF02; font-family:Arial; font-size: 20px; text-align: center;">Transforming raw football data into golden scouting reports through AI alchemy.</h1>', unsafe_allow_html=True)
